...
CREATE TABLE `courses` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `courses_code_name_unique` (`code_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (5,'2023_06_08_010152_create_students_table',1);
INSERT INTO `migrations` VALUES (6,'2023_06_08_152719_create_courses_table',1);
INSERT INTO `migrations` VALUES (7,'2023_06_08_153525_create_attendances_table',1);
